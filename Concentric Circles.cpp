 ...
 *
 * Features:
 * - Complete Liang-Barsky parametric clipping
 * - Takes multiple line segments as input
 * - Clips against rectangular window
 * - Shows original and clipped portions in different colors
 * - Handles all cases: inside, outside, intersecting
 *
 * Controls:
 * - Click two points to draw a line
 * - Arrow keys to move clipping window
 * - C to clear
 * - ESC to exit
 */
